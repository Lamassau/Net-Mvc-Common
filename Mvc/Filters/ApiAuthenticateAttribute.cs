...
namespace TeknoMobi.Common.Mvc
{
    ...
    {
        string GetHashedPassword(string apiKey);
    }

    //Usage http://stackoverflow.com/a/11782361/130083 
    //User-Agent: {agent}   
    //Host: {host}   
    //Timestamp: {timestamp}
    ...
    public class ApiAuthenticateAttribute : ActionFilterAttribute
    {
        ...
        public ApiAuthenticateAttribute(IAppKeyService _service)
        {
            Service = _service;
        }
        
        public IAppKeyService Service { get; set; }
        ...
        {
            return Service.GetHashedPassword(username);
        }
