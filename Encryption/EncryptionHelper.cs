...
namespace TeknoMobi.Common.Helpers
{
    public class EncryptionHelper
    {
        ...
        {
            return EncryptStringAES(value, "X7GIrF5DAP");
        }

        public static string Decrypt(string value)
        {
            return DecryptStringAES(value, "X7GIrF5DAP");
        }



        private static byte[] _salt = Encoding.ASCII.GetBytes("MuYvCl2qkGOMHPimzfmmuXLS3Rxkm1");
